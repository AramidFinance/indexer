...
func TestLedgerForEvaluatorApp(t *testing.T) {
	...
	txn0 := test.MakeSimpleAppCallTxn(0, basics.Address(test.AccountA))
	txn1 := test.MakeAppCallTxnWithLogs(0, basics.Address(test.AccountA), []string{"testing"})
	...
	txn5 := test.MakeSimpleAppCallTxn(0, basics.Address(test.AccountB))
...
func TestLedgerForEvaluatorAssetCreatorMultiple(t *testing.T) {
	...
	creatorsMap := map[basics.AssetIndex]basics.Address{
		1: basics.Address(test.AccountA),
		2: basics.Address(test.AccountB),
		3: basics.Address(test.AccountC),
		4: basics.Address(test.AccountD),
	}
...
func TestLedgerForEvaluatorAppCreatorMultiple(t *testing.T) {
	...
	txn0 := test.MakeSimpleAppCallTxn(0, basics.Address(test.AccountA))
	txn1 := test.MakeSimpleAppCallTxn(0, basics.Address(test.AccountB))
	txn2 := test.MakeSimpleAppCallTxn(0, basics.Address(test.AccountC))
	txn3 := test.MakeSimpleAppCallTxn(0, basics.Address(test.AccountD))
